...
Page({
    ...
    submit: function() {
        ...
        console.log(s)
        r.data.posting || ("" != s.realname && s.realname ? "" != s.mobile && s.mobile ? "" != s.city && s.city  ? "" != s.address && s.address ?  i.isMobile(s.mobile) ? (s.id = r.data.id, 
        r.setData({
            posting: !0
        ...
        })) : a.toast(r, "请填写正确联系电话") : a.toast(r, "请填写详细地址") : a.toast(r, "请选择所在地区") : a.toast(r, "请填写联系电话") : a.toast(r, "请填写收件人"));
    },
    onChange: function(t) {
    ...
    bindRegionChange: function (e) {
        ...
        this.setData({
          ...
          'detail.province': e.detail.value[0],
          'detail.city': e.detail.value[1],
          'detail.area': e.detail.value[2],
        })
      },
    selectArea: function(t) {
        console.log(this.data.areas)
        console.log( t.currentTarget.dataset.area)
